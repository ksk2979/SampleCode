...
public static class LocalizeText
{
    ...
    public static ConfigSetting _configSetting
    {
        get
        {
            if (configSetting == null)
            {
                ...
                configSetting.systemLanguage = (SystemLanguage)Enum.Parse(typeof(SystemLanguage), PlayerPrefs.GetString(CommonStaticDatas.STR_KEY_LOCALLANGUAGE, Application.systemLanguage.ToString()) );
            }
    ...
    internal static void SetCinfigLang(SystemLanguage value)
    {
